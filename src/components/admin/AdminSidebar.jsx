...
import {
  ...
  Shield, ArrowLeft, Lock, BookOpen, GraduationCap, Inbox, Zap, Handshake, FileText, Library, HandHelping, LogOut as LogOutIcon,
} from "lucide-react";
...
const navItems = [
  ...
  { key: "termination", label: "Desligamentos", icon: LogOutIcon, desc: "Solicitações de saída" },
  { key: "reception", label: "Recepção & Sombra", icon: HandHelping, desc: "Inscrições e seleção" },
